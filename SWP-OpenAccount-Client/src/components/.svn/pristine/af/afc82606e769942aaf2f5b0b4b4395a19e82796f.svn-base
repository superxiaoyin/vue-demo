    ...
    export default {
        ...
        methods: {
            ...
            showBranch:function(){
                ...
                cryptPost('openAccount/downloadBranchBankList.do', {bankId:bankId,cityId:cityId}).then(function(result){ //根据已选银行，省市，请求支行
            ...
            showorderTimeId:function(){
                ...
                cryptPost('openAccount/getBranchPeriodInfo.do', {branchId:branchId}).then(function(result){ //根据已选银行，省市，请求支行
