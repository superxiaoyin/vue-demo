        ...
        <step-header class="step-header" :step="2"></step-header>
          <div class="person-info">
            ...
            <SnText
                ...
                text-align="left"
                placeholder="请输入地址"
                v-model="cardInfo.registAddress"
            ></SnText>
            <SnPopupPicker
                class="sn-text"
                title="职业"
...
import { openRouterByValue, setBusinessData, getProfessionList, getBusinessData, setLocalData,getLocalData  } from '../../handler/handler'
    ...
    methods:{
        init(){
            ...
            if(!!_this.$route.query.orderNo){
                ...
                _this.cardInfo = new CardInfoModel(_this.cardData);
            }
        },
        nextStep(){
            let _this = this;
            ...
            openRouterByValue("step3",{orderNo:encodeURIComponent(_this.orderNo)},_this);
        }
    },
    watch:{
        profession(newVal,oldVal){
            let _this = this;
            if(!!newVal){
                _this.cardData.profession = _this.profession;
                setBusinessData(_this.orderNo,_this.cardData);
            }
        }
    }
}
