...
export default {
    ...
    computed:{
        ...
        payurl(){
            return this.operateType===1?'/yqt/accountMgr/accountMgr.charge':'/yqt/accountMgr/accountMgr.cashout'
        }
    },
    components:{
        ...
        async confirmOperate(){
            ...
            try {     
                ...
                //     }
                    ...
                    const payResult = await getServerDataH5(textUrl+_this.payurl,payData);
                    _this.payLoading = false;
                    _this.payText = _this.subTitle;
                    // let data = {};
