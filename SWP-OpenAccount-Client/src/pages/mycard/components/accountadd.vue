...
export default {
    ...
    methods:{
        ...
        init(){
            ...
            if(!!getBusinessData(_this.sessionKey)&&!!getBusinessData(`${_this.cardData.cardNumber}superAccountData`)){
                _this.superCardList = getNonSuperList(getBusinessData(_this.sessionKey),getBusinessData(`${_this.cardData.cardNumber}superAccountData`));
            }
        },
        /**
         * 新加银行卡
        ...
        addCard(){
            let _this = this;
            openRouterByValue('cardadd',{cardData:decodeURIComponent(JSON.stringify(_this.cardData)),phone:_this.phone},_this);
        },
        /**
         * 确认加挂
         */
        confirmAdd(){
            ...
            if(!!_this.superCardList[_this.chooseIndex]){
                ...
                openRouterByValue('verifycode',{addData: encodeURIComponent(JSON.stringify(addData)),phone:_this.phone},_this);
            }
