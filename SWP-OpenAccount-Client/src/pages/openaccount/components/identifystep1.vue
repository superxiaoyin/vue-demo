...
<script>
import { openRouterByValue,openNativePage,setBusinessData,setLocalData,deleteLocalData,getLocalData,deleteLocalStorage,getServerDataH5 } from '../../handler/handler'
...
import { throttle,getUrlParams, goBackPage, initTitleMenu, showToast } from 'sslib/common/extend'
...
export default {
    ...
    created(){
        ...
        if(getLocalData(phone)){
            setBusinessData(phone,getLocalData(phone))
            deleteLocalStorage(phone)
        }
    ...
    methods:{
        ...
        async nextStep(){
            ...
            try {
                ...
                getServerDataH5(textUrl+'/yqt/certification/certificateTencent.ocrIdCard',param,'GET').then(result => {
                    ...
                    if(result.code===0){
                        ...
                        if(!!data.orderNo){
                            ...
                            openRouterByValue("identifystep2",{orderNo:encodeURIComponent(data.orderNo)},_this);
                        }
                    }else{
                ...
                // sendPost('GET','https://lzccbdev.sinosun.com:12443/yqt/certification/certificateTencent.ocrIdCard',param, 'json').then(result =>{
                //     if(!!result && result.code == 0){
                ...
                //     }
                // }, rej => {
                //     console.log("certificateTencent.ocrIdCard - 网络异常...");
                // });
         ...
         * @constructor
         */
        compressImage(filesrc, quality = 0.5) {
            return new Promise(function (res, rej) { 
                var file = filesrc;
                // 图片小于3M不压缩
                // let imageMaxSize = 1024*1024;
                let imageMaxSize = 1024;
