...
<script>
import Vue from 'vue';
import { appList,getServerData,setBusinessData,getBusinessData,deleteBusinessData,formatProduct,openNativePage, openRouterByValue,setLocalData,getLocalData,deleteLocalStorage, getServerDataH5} from '../../handler/handler'
