<template>
  <div>
    <div class="templet-list">
         <!-- <div v-if="listType==2" class="templet-item" @click="openTicketShop()">
        ...
        <div class="templet-item" @click="openInsurancePage()">
            <div class="templet-inner-div">
                <img class="icon" src="../../../resource/img/icon_账户管理@2x.png" alt="">
                <div class="content-div">保险</div>
            </div>
        </div>
        <div v-if="listType==1" class="templet-item" @click="openWealth()">
            <div class="templet-inner-div">
                <img class="icon" src="../../../resource/img/icon_月月红@2x.png" alt="">
                <div class="content-div">月月红</div>
            </div>
        </div>
        <div v-if="listType==1" class="templet-item" @click="openPersonalWealth()">
            <div class="templet-inner-div">
                <img class="icon" src="../../../resource/img/icon_个人财富@2x.png" alt="">
                <div class="content-div">个人财富</div>
            </div>
        </div>
        <!-- <div v-if="listType==2" class="templet-item" @click="openMyTicket()">
            <div class="templet-inner-div">
                <img class="icon" src="../../../resource/img/icon_个人财富@2x.png" alt="">
                <div class="content-div">我的票</div>
            </div>
        </div> -->
        
        <!-- <div class="templet-item" @click="openMyCardPage()">
            <div class="templet-inner-div">
                <img class="icon" src="../../../resource/img/icon_购票@2x.png" alt="">
                <div class="content-div">购票</div>
            </div>
        </div> -->
    </div>
  </div>
...
export default {
    ...
    methods:{
        ...
        openInsurancePage(){
            window.location.href = 'insurance.html?phone='+phone+'#/';
        },
        openAccountPage(){
            openRouterByValue("account",{phone:phone},this);
            // let _this = this;
            // getServerDataH5(textUrl+'/yqt/user/user.queryCertificationByPhone',{phone:phone},'GET').then(result => {
            //     if(result.code===0){
            //         let data = result;
            //         if(data.status==1){
            //             window.location.href = 'account.html?phone='+phone;  
            //         }else if(data.status==2){
            //             showToast('请先进行实名认证');
            //         }
            //     }else{
