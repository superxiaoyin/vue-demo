...
function initNumberKeyboard() {
  ...
  //绑定输入框
  numberKeyboard.bindInputBox('pwd');
  numberKeyboard.setCipherType(CIPHER_TYPE_SM2, 'pwd');
...
function initSipBoxNum(SipBoxId, random){
    ...
    passwordInput.addEventListener('focus', function (evt) {
      ...
      //初始化光标状态
      document.getElementById('pwdCursor').style.display = 'none';
