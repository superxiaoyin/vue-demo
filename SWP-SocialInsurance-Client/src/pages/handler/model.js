export class WealthPayModel{
    constructor(amount,payerAccount,pName,pCode,finance){
        this.cpyId = -1;
        this.businessType = 1;
        this.pType = 1;
        this.amount = amount;
...
export class WealthRedeemModel{
    constructor(bankFinanceNo,amount,payeeAccount,pName,pCode,finance){
...
export class OperatePayModel{
    constructor(payerAccount,payerName,payeeAccount,payeeName,amount){
        this.payerAccount = payerAccount;
