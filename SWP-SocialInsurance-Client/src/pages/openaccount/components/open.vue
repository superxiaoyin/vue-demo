...
<script>
import {openRouterByValue,backRouterByValue, getServerData, getBusinessData,setBusinessData, getServerDataH5,getLocalData} from '../../handler/handler'
    ...
    methods: {
        init() {
            ...
            if(!!_this.$route.query){
                ...
                _this.content.telphone = _this.$route.query.telphone || _this.$route.query.phone || '';
            ...
            if(!!orderNo){
                ...
                if(!_this.cardData){
                    ...
                    if(!_this.content.name){
                        _this.content.name = _this.cardData.name || '';
                    }
                    _this.content.orderNo = orderNo;
                    _this.content.h5faceId = h5faceId;
                    _this.content.mPhone = _this.cardData.phone;
                    _this.content.telphone = _this.cardData.phone;
                }else{
                    if(!_this.content.name){
                        _this.content.name = _this.cardData.name || '';
                    }
        ...
        nextStep(){
            ...
            const data = {
                ...
                telphone: _this.content.telphone,
                vCode: _this.content.verifyCode,
                phone: _this.content.mPhone,
                orderNo:orderNo,
                faceId:h5faceId,
            };
        ...
        getendingfun(data) {
            ...
            if (data) {
                let param = {
                    userPhone:_this.content.telphone,
                    vType:16
                }
