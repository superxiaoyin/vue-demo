<template>
	<div class="SnTree">
        ...
        <popup  v-model="popupShowFlag" position="right" width="100%">
			...
			<div v-transfer-dom class="checksubmitButWrap" :class="{inaddOrg:isinaddOrg}">
...
<script>
	...
	import {Popup,PopupHeader,Cell,TransferDom} from 'vux';
	import xTree from '../xTreeCompanyMgr/xTree.vue';
    export default {
		directives: {
			TransferDom
		},
        ...
        methods: {
            ...
            getOrgTree:function(){
    			...
    			cryptPost('../../companymgr/orgnization/downloadCpyOrgTree.do',json).then(function(result){
					if(!!result){
						var tempOrgList = [];
